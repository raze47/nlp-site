...
<body>
    <section class="d-flex flex-column justify-content-between" id="log-in">
        ...
        <div id="nlp-body"><img class="d-print-none d-sm-none d-md-none d-lg-none d-xl-none" id="pylon-top" src="assets/img/PUP_Mabini_Campus_-_pylon_(side_view)_(PUP,_Santa_Mesa,_Manila)(2018-03-06).jpg" width="100%" style="filter: brightness(126%);">
            <div class="container">
                <div class="row">
                    <div class="col d-none d-print-inline d-sm-inline d-md-inline d-lg-inline d-xl-inline" id="img-col"><img id="pylon-img" src="assets/img/PUP_Mabini_Campus_-_pylon_(side_view)_(PUP,_Santa_Mesa,_Manila)(2018-03-06).jpg" width="100%" style="filter: brightness(126%);"></div>
