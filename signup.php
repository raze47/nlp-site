...
<body>
    <section class="d-flex flex-column justify-content-between" id="sign-up">
        ...
        <div id="nlp-body"><img id="pylon-top" src="assets/img/PUP_Mabini_Campus_-_pylon_(side_view)_(PUP,_Santa_Mesa,_Manila)(2018-03-06).jpg" width="100%" style="filter: brightness(126%);">
        ...
        <div id="nlp-bottom" style="background: #ffffff;">
            <div class="card d-xl-flex justify-content-xl-center align-items-xl-center" id="nlp-ribbon" style="background: rgb(255,255,255);text-align: center;"><img class="card-img w-100 d-block" src="assets/img/PUP_school_colors.png" width="100%" height="30px">
                <div id="footer-images" style="background: #ffffff;">
                    <div class="container d-flex d-md-flex justify-content-center justify-content-md-center"><img id="pup-logo" src="assets/img/logo.png" width="70px" height="70px"><img src="assets/CCIS Logo.png" width="70px" height="70px"></div>
