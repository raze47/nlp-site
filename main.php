    ...
    <section class="d-flex flex-column justify-content-between" id="about-us">
        ...
        <div id="nlp-body">
            <div class="container" id="professors-container" style="background: #ffffff;">
                <h6 class="text-left" id="prof-title" style="font-family: Montserrat, sans-serif;font-size: 20px;color: rgb(65,70,75);">Professor</h6><img id="line-separator1" src="assets/img/line.png" width="100%" height="10px"><img id="prof-img" src="assets/img/download (3).jpeg">
            ...
            <div class="container names" id="contributors-panel" style="background: #ffffff;">
                <h6 class="text-left" id="contributors-title" style="font-family: Montserrat, sans-serif;font-size: 20px;color: rgb(65,70,75);">Contributors</h6><img id="line-separator2" src="assets/img/line.png" width="100%" height="10px">
